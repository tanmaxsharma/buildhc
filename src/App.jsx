...
const VIDEO_SOURCES = {
  ...
  forest: "https://sample-videos.com/video321/mp4/720/big_buck_bunny_720p_1mb.mp4",
    ...
    >
      ...
      <div className="min-h-screen flex flex-col justify-center items-center relative px-4 sm:px-6">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <button
            className={`px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-base sm:text-lg font-semibold hover:scale-105 transition-all duration-300 flex items-center space-x-2 mx-auto shadow-xl ${
              isDarkMode
